...
- [x] O(N) 98. Validate Binary Search Tree - <https://leetcode.com/problems/validate-binary-search-tree/>
...
- [x] O(2^N) 967. Numbers With Same Consecutive Differences - <https://leetcode.com/problems/numbers-with-same-consecutive-differences/>
